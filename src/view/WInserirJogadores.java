...
public class WInserirJogadores extends JFrame {
	...
	//In�cio da parte do JPanel panelHeader
	...
	public void btnFechar(JPanel panelHeader)
	{
		...
		btnFechar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				int resposta = JOptionPane.showConfirmDialog(null, "Deseja fechar?", "Olimp�ada de Hist�ria Fafica",JOptionPane.YES_NO_OPTION);
	...
	//In�cio da parte do JPanel panelAddJogador
		...
		btnAdicionar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(nome.isEmpty()){
					...
					JOptionPane.showMessageDialog(null, "Insira um nome de jogador com no m�ximo 15 caracteres.",
					...
					if(contador == 0){
						...
						JOptionPane.showMessageDialog(null, "O jogador " + nome + " j� existe.");
					}
				}
	...
	//In�cio da parte do JPanel panelListaJogadores
